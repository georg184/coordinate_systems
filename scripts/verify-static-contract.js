...
assert.match(indexSource, /id="xCoordinateInput"[^>]*placeholder="v_x"/);
assert.match(indexSource, /id="yCoordinateInput"[^>]*placeholder="v_y"/);
...
assert.ok(appSource.includes('controls.xCoordinateInput.placeholder = `${task.vector.name.text}_x`;'));
assert.ok(appSource.includes('controls.yCoordinateInput.placeholder = `${task.vector.name.text}_y`;'));
